...
int main()
{
	...
	cout << ".set BLOCKI_FSIZE, " << QT_BLOCKI_FRAME_SIZE << endl;
	cout << ".set BLOCKI_CR_SAVE, " << QT_BLOCKI_CR_SAVE << endl;
	cout << ".set BLOCK_FSIZE, " << QT_BLOCK_FRAME_SIZE << endl;
	...
	cout << endl;
	i = 13;
	cout << ".set GPR_SAVE_" << i << ", " << QT_BLOCKI_GPR_SAVE(i) << endl;

	cout << endl;
	for(i=31; i>13; i--)
	 	cout << ".set FPR_SAVE_" << i << ", " << QT_BLOCK_FPR_SAVE(i) << endl;

	cout << endl;
	cout << ".set VARGS_BKOFF, " << QT_VARGS_BKOFF << endl;
